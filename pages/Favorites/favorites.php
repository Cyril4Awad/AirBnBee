...
<body>
    ...
    <section id="featured-listings">
        <div class="container-fluid">
            <h2 style="  text-align: center;padding: 20px;margin: 20px;">Favorites Listings</h2>
            <?php
            // Get the user_id from the session
            $user_id = $_SESSION['userId'];

            $sql = "SELECT l.ad_title, l.rent_price, l.upload_directory, f.ad_id FROM favorites f
        JOIN listing l ON f.ad_id = l.ad_id
        WHERE f.user_id = ?";
            ...
            if ($result->num_rows == 0) {
                echo "<h5 style='margin-top:30px;'>No favorites found.</h5>";
            } else {
                                ...
                                <div class="listing">
                                    <div id="Listing<?php echo $carouselID; ?>Carousel" class="carousel slide" data-ride="carousel">
                                        ...
                                        <a class="carousel-favorite">
                                            <form method="post" action="../home page/update_favorite.php">
                                                <button type="submit" style="border: none; background: none; color: inherit;">
                                                    <input type="hidden" name="ad_id" value="<?php echo $row['ad_id']; ?>">
                                                    <span class="glyphicon glyphicon-heart" role="button" onclick="changeClass(this)"></span>
                                                </button>
