...
if ($userId) {
    echo "<script>alert('User ID: " . htmlspecialchars($userId, ENT_QUOTES, 'UTF-8') . "');</script>";
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['publish'])) {
        ...
        $query = "INSERT INTO listing (ad_title, description, property_type, size, check_in_host, rent_price, num_bedrooms, num_guests, country, city, street_number, zip_code, file_path, upload_directory, user_id) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
        
        if ($stmt = $conn->prepare($query)) {
            $stmt->bind_param("sssssissssssssi", $title, $description, $type, $size, $check_in_host, $price, $bedrooms, $guests, $country, $city, $street, $zip, $filesArray, $uploadDirectory, $userId);
...
<head>
    ...
    <!-- Custom CSS -->
    <link rel="stylesheet" href="../create listing/hosting.css">
                ...
                <div class="row">
                    ...
                    <div class="col-md-5 col-md-pull-7">
                        <div class="booking-form">
                            <form action="adminhosting.php?user_id=<?php echo htmlspecialchars($userId); ?>" method="post" enctype="multipart/form-data">
